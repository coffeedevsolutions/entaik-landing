            ...
            {onNavigate ? (
              <>
                <Button 
                  ...
                  className="bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 cursor-pointer"
                >
                  Request a Demo
                </Button>
                <Button 
            ...
            {onNavigate ? (
              <>
                <Button 
                  size="lg"
                  onClick={() => onNavigate("request-demo")}
                  className="bg-white text-orange-600 hover:bg-gray-100 cursor-pointer"
                >
                  Request a Demo
                </Button>
                <Button 
